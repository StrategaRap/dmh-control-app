      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <div className="col-span-2 md:col-span-2">
            ...
            <div className="flex space-x-2">
                <input 
                    type="time" 
                    className="w-1/2 border-slate-200 bg-white border rounded-lg p-2 text-sm font-medium focus:ring-2 focus:ring-brand-primary outline-none"
                    value={data.startTime}
                    onChange={(e) => onChange(data.id, 'startTime', e.target.value)}
                />
                <input 
                    type="time" 
                    className="w-1/2 border-slate-200 bg-white border rounded-lg p-2 text-sm font-medium focus:ring-2 focus:ring-brand-primary outline-none"
                    value={data.endTime}
                    onChange={(e) => onChange(data.id, 'endTime', e.target.value)}
                />
            </div>
        </div>
